...
@Component({
  selector: 'app-janalysis',
  templateUrl: 'janalysis.page.html',
  styleUrls: ['janalysis.page.scss']
})
export class Janalysis {
  ...
  public cartService: JCartService
