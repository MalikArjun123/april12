...
@Component({
  ...
  <div >
    ...
    <ion-text color="dark"><h5>Trader-Smarty</h5></ion-text>
...
// public productQty = 3;
  constructor(private route: ActivatedRoute,public popoverCtrl: PopoverController,  public cartService: SCartService,private webIntent: WebIntent) {
