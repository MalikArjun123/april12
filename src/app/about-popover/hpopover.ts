...
@Component({
  ...
  <div >
    ...
    <ion-text color="dark"><h5>Trader-Harry</h5></ion-text>
...
// public productQty = 3;
  constructor(private route: ActivatedRoute,public popoverCtrl: PopoverController,  public cartService: HCartService,private webIntent: WebIntent) {
