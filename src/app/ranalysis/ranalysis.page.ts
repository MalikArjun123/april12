...
// import {productQty} from '../services/cart.service';
...
@Component({
  selector: 'app-ranalysis',
  templateUrl: 'ranalysis.page.html',
  styleUrls: ['ranalysis.page.scss']
})
export class Ranalysis {
...
//  public productQty=0;
  // cart: Cart ={};
  // public vnv=this.cart.productQty;
  addToCart() {
    // this.topSavers.products[index].units = 1
    // this.cart.addCart.push(this.topSavers.products[index])
  //  this.cartService.pay = 4
    this.cartService.productQty += 1
  }
//   async openDetails(parameter: any) {
//     await this.storage.set('productQty', parameter);
//     await this.navCtrl.navigateForward(['../about-popover/about-popover']);
// }
  updateCart(type) {
...
// }
// goToProductDetails(productQty) {
//   this.router.navigate(['../about-popover/about-popover', productQty]);
// }
